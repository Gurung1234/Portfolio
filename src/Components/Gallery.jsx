...
const Gallery = () => {
  ...
  return (
    <div className="bg-[#323946] text-light-gray lg:px-32 md:px-20 px-2 pb-8 md:pb-13 lg:pb-15 pt-8 md:pt-13 lg:pt-15">
      <h1 className="font-bold text-white text-3xl text-center py-10 font-serif">Gallery</h1>

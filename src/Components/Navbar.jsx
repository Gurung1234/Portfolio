...
import { FaFacebook, FaGithubSquare, FaInstagram, FaLinkedin } from "react-icons/fa";
            ...
            <div className="flex gap-4 items-center font-serif text-white">
          <p >Find me:</p>
...
const Navbar = () => {
  ...
  return (
    <div className='bg-[#1f242d] text-white lg:px-32 md:px-20 px-2 sticky top-0 z-50 font-normal'>
        <div className=' hidden md:flex md:flex-row md:justify-between md:items-center md:py-1 lg:font-semibold '>
            <div className='flex flex-row justify-center items-center'>
                <NavLink className='text- font-bold p-3 cursor-pointer hover:text-light-gray font-serif' to='/'>Roshan Gurung</NavLink>
            </div>
            <div className='flex flex-row lg:gap-10 gap-4 '>
                <NavLink  to="/"className={({ isActive }) => `text-white duration-300 ease-in-out font-serif hover:text-[#00ffff] ${  isActive ? 'text-[#00ffff] font-bold' : ''    }` }>Home</NavLink>
                <NavLink  to='/skills' className={({ isActive }) => `text-white duration-300 ease-in-out font-serif hover:text-[#00ffff] ${  isActive ? 'text-[#00ffff] text-warm-orange font-bold' : ''    }` }>Skills</NavLink>
                <NavLink   to='/projects' className={({ isActive }) => `text-white duration-300 ease-in-out font-serif hover:text-[#00ffff] ${  isActive ? 'text-[#00ffff] text-warm-orange font-bold' : ''    }` }>Projects</NavLink>
                ...
                <NavLink  to='/about' className={({ isActive }) => `text-white duration-300 ease-in-out font-serif hover:text-[#00ffff] ${  isActive ? 'text-[#00ffff] text-warm-orange font-bold' : ''    }` }>About</NavLink>
                <NavLink  to='/blog'className={({ isActive }) => `text-white duration-300 ease-in-out font-serif hover:text-[#00ffff] ${  isActive ? 'text-[#00ffff] text-warm-orange font-bold' : ''    }` }>Blogs</NavLink>
                <NavLink  to='/gallery'className={({ isActive }) => `text-white duration-300 ease-in-out font-serif hover:text-[#00ffff] ${  isActive ? 'text-[#00ffff] text-warm-orange font-bold' : ''    }` }>Gallery</NavLink>
            </div>
